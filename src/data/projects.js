...
export const projects = [
  ...
  },
  {
    ...
    description: {
      fr: "Boutique e-commerce complète pour une bijouterie fantaisie, bilingue FR / AR (RTL) : catalogue, panier, paiement à la livraison (58 wilayas) et dashboard admin.",
      en: 'Full e-commerce store for a fashion jewellery brand, bilingual FR / AR (RTL): catalogue, cart, cash-on-delivery (58 wilayas) and admin dashboard.',
    },
    image: '/projects/bijouxjoelle.png',
    imageFit: 'contain',
    liveUrl: 'https://bijouxjoelle.com/',
    githubUrl: '',
    accent: '#C79A3B',
    featured: true,
  },
  {
    ...
    tags: ['React', 'Vite', 'Tailwind', 'Supabase'],
    description: {
      fr: "Boutique e-commerce de coques iPhone antichoc : 69 modèles, filtres par modèle et collection, paiement à la livraison et dashboard admin.",
      en: 'E-commerce store for shockproof iPhone cases: 69 models, filters by model and collection, cash-on-delivery and admin dashboard.',
    },
    image: '/projects/casephone06.jpg',
    imageFit: 'contain',
    liveUrl: 'https://phone-case-blue.vercel.app/',
    githubUrl: '',
    accent: '#0FB5AE',
    featured: true,
  },
  ...
  },
  {
    ...
    image: '/projects/justprint-logo.jpg',
    imageFit: 'contain',
  ...
  },
  {
    ...
    description: {
      fr: "Logiciel de caisse pour salle de jeux : gestion des postes PS4 / PS5, sessions chronométrées, tarifs et suivi des recettes.",
      en: 'POS software for a gaming lounge: PS4 / PS5 station management, timed sessions, pricing and revenue tracking.',
    },
    image: '',
